...
void E64::blitter_ic::connect_exceptions_ic(TTL74LS148_ic *unit)
{
	TTL74LS148 = unit;
	interrupt_device_no = TTL74LS148->connect_device(4);
...
void E64::blitter_ic::reset()
{
	...
	if (exceptions_connected) TTL74LS148->release_line(interrupt_device_no);
}
