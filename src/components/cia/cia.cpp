...
uint8_t E64::cia_ic::io_read_8(uint8_t address)
{
...
void E64::cia_ic::io_write_8(uint8_t address, uint8_t byte)
{
	switch (address) {
	case 0x01:
		if (byte & 0b00000001) {
