...
/*
 *  Register 0x00 - CIA Status Register
 *
 *  7 6 5 4 3 2 1 0
 *                |
 ...
 *
 *
 *  Register 0x01 - CIA Control Register
 *
 *  7 6 5 4 3 2 1 0
 *  |             |
 ...
 *
 *
 *  Register 0x02 - Keyboard Repeat Delay, 1 byte, in multiples of 10ms (READ/WRITE)
 *
 *  Register 0x03 - Keyboard Repeat Speed, 1 byte, in multiples of 10ms (READ/WRITE)
 *
 *  Register 0x04 - Contains next key ascii code (READ), returns 0 on events available
 *
 *  Register 0x80 --> Start of key state array
 *
 */
