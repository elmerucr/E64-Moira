...
{
	use_custom_rom = false; // default setting
...
//	lua_getglobal(L, "scanlines_linear_filtering");
//	if (lua_isboolean(L, -1)) {
//		scanlines_linear_filtering_at_init = lua_toboolean(L, -1);
//	} else {
//		scanlines_linear_filtering_at_init = true;
//	}
...
void E64::settings_t::process_command_line_arguments(int argc, char **argv)
{
	if (argc > 1) {
		// process arguments
